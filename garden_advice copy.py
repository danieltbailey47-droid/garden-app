...
# - Replaced hardcoded values with user input (Completed: March 26, 2026)
# - Refactored the program into functions for season and plant advice (Completed: March 26, 2026)

# Future Improvements
# - Add more detailed comments explaining each block of code
# - Store advice in dictionaries for multiple plants and seasons
